      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          {stats.map((stat) => {
            ...
            return (
              <div key={stat.label} className="text-center">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gold/20 rounded-xl mb-3">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-6">
            ...
            <span className="text-gradient-gold">projetistas verificados</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-gold hover:bg-gold-light text-primary font-semibold text-lg px-8 shadow-gold group"
            >
