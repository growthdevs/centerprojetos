  ...
  return (
    <div className="fixed inset-0 bg-background flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto overscroll-contain">
        <main className="container mx-auto px-4 py-8 flex flex-col items-center max-w-lg pb-24">
          ...
          {/* Terms Box (no nested scroll; single page scroll) */}
          <div className="w-full bg-muted/50 rounded-lg p-4 mb-6 text-sm text-muted-foreground">
            <p className="mb-4">
