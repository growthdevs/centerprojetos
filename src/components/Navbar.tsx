...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-gold/20 transition-colors duration-300 ${
      isScrolled ? "bg-primary/95" : "bg-primary/70"
    }`}>
